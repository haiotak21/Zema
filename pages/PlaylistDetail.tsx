...
import { Play, Pause, Clock, Heart, MoreHorizontal, ArrowLeft, Shuffle, Share2, ListPlus, Check } from 'lucide-react';
...
interface PlaylistDetailProps {
  ...
  onSongMoreOptions?: (song: Song, e: React.MouseEvent) => void;
  onShare?: () => void;
}
        ...
        <div className="min-h-screen bg-white dark:bg-black pb-40 animate-in fade-in slide-in-from-right-8 z-50 absolute inset-0 overflow-y-auto">
            ...
            <div className="relative h-[40vh] min-h-[300px] w-full overflow-hidden bg-zinc-900">
                ...
                <div className="absolute bottom-8 left-0 right-0 px-4 md:px-8 z-10 flex flex-col md:flex-row items-end gap-6 md:gap-8 max-w-7xl mx-auto">
                    <div className="h-48 w-48 md:h-60 md:w-60 shadow-2xl shadow-black/50 rounded-lg overflow-hidden flex-shrink-0">
                    ...
                    <div className="flex-1 text-center md:text-left space-y-2 mb-2">
                        ...
                        <p className="text-white/80 text-sm md:text-base font-medium drop-shadow-sm max-w-2xl">
                           The best tracks selected just for you. Updated daily.
                        </p>
                        <div className="flex items-center justify-center md:justify-start gap-2 text-white/90 text-sm font-medium pt-2">
                             <div className="h-6 w-6 rounded-full bg-rose-600 flex items-center justify-center text-[10px] font-bold">Z</div>
                             <span>Made by Zema</span>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-8">
                    ...
                    <button 
                        onClick={onPlayPlaylist} // In real app, this would shuffle logic
                    ...
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className={`border rounded-full px-4 h-10 font-bold text-sm transition-colors ${
                                isFollowing 
                                ? 'border-rose-500 text-rose-500' 
                                : 'border-zinc-300 dark:border-zinc-600 text-zinc-600 dark:text-zinc-300 hover:border-zinc-900 dark:hover:border-white'
                            }`}
                        >
                        ...
                        <button 
                            onClick={onMoreOptions}
                            className="p-3 rounded-full text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors md:hidden"
                        >
                            <MoreHorizontal size={24} />
                        </button>
                    </div>
                            ...
                            <div className="flex justify-end">
                                {onSongMoreOptions && (
                                    <button 
                                        ...
                                        onClick={(e) => onSongMoreOptions(song, e)}
                                    >
